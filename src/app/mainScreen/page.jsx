                    ...
                    <div className="Card-Track">
                        ...
                        <a href="/form">  <Card className="SingleCard">
                            ...
                            <CardContent>
                                <h1 className="CardH1" >Brooklyn Nine-Nine</h1>
                                <p>
                                    A Brooklyn Nine-Nine" is a comedy < br />series about a quirky NYPD precinct led <br /> by Detective Jake Peralta and stern <br /> Captain Holt </p>
                            </CardContent>
                        ...
                        <a href="/form">       <Card className="SingleCard">
                            ...
                            <CardContent>
                                ...
                                <p>
                                    A thrilling adventure where dinosaurs are brought back to life in a theme park, <br /> leading to chaos and survival challenges.
                                </p>
                            </CardContent>
